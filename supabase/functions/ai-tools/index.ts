    ...
    if (action === "summarize_bullets") {
      ...
      switch (action) {
        case "generate_article":
          systemPrompt = "أنت كاتب صحفي محترف في القيادة 24. اكتب مقالات إخبارية باللغة العربية بأسلوب مهني ودقيق.";
        ...
        case "generate_seo":
          systemPrompt = "أنت خبير SEO. أنشئ هاشتاقات فقط للمقال. أعطِ من 5 إلى 8 هاشتاقات مناسبة. كل هاشتاق يبدأ بعلامة # وبدون مسافات داخلية. أضف دائماً #القيادة_24 و #Alqiada24. اكتب الهاشتاقات فقط بدون أي شرح أو تفاصيل، كل هاشتاق في سطر منفصل.";
